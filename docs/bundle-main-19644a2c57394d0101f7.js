...
var FOREST = 4;
var STONE = 5;
var colors = (_colors = {}, _defineProperty(_colors, WATER, [0, 0.4, 0.8]), _defineProperty(_colors, SAND, [0.8, 0.8, 0]), _defineProperty(_colors, GRASS, [0, 0.5, 0]), _defineProperty(_colors, DIRT, [0.5, 0.3, 0.1]), _defineProperty(_colors, FOREST, [0.2, 0.4, 0.3]), _defineProperty(_colors, STONE, [0.5, 0.5, 0.5]), _colors);
var container, stats;
...
function cutCliffs() {
  ...
  var heightIndexFactor = 2 / _fforw_organic_quads__WEBPACK_IMPORTED_MODULE_5__["g_size"];
  ...
  for (var i = 0; i < length; i += _fforw_organic_quads__WEBPACK_IMPORTED_MODULE_5__["t_size"]) {
    ...
    var tIdx3 = n3 * heightIndexFactor; // find indizes for connected centroid (values might be -1 if on the edge or already cut)
    ...
    if (cutMask !== 0) {
      ...
      for (var _j = 0; _j < 4; _j++) {
        if (cutMask & 1 << _j) {
          var heightMapIndex = tiles[i + _fforw_organic_quads__WEBPACK_IMPORTED_MODULE_5__["t_n0"] + _j] * heightIndexFactor;
          heightMap[heightMapIndex + h_cutZ] = height;
...
function createScene() {
  ...
  var length = graph.length;
  heightMap = new Float64Array(length / _fforw_organic_quads__WEBPACK_IMPORTED_MODULE_5__["g_size"] * 2);
  var pos = 0;
...
function addHeightMap() {
  ...
  for (var i = 0; i < length; i += _fforw_organic_quads__WEBPACK_IMPORTED_MODULE_5__["t_size"]) {
    ...
    var x0 = graph[n0 + _fforw_organic_quads__WEBPACK_IMPORTED_MODULE_5__["g_x"]]; //const y0 = heightMap[heightIndex0 + h_cutZ] === -1 ? heightMap[heightIndex0] : heightMap[heightIndex0 + h_cutZ];

    var y0 = heightMap[heightIndex0];
    var z0 = graph[n0 + _fforw_organic_quads__WEBPACK_IMPORTED_MODULE_5__["g_y"]];
    var x1 = graph[n1 + _fforw_organic_quads__WEBPACK_IMPORTED_MODULE_5__["g_x"]]; //const y1 = heightMap[heightIndex1 + h_cutZ] === -1 ? heightMap[heightIndex1] : heightMap[heightIndex1 + h_cutZ];

    var y1 = heightMap[heightIndex1];
    var z1 = graph[n1 + _fforw_organic_quads__WEBPACK_IMPORTED_MODULE_5__["g_y"]];
    var x2 = graph[n2 + _fforw_organic_quads__WEBPACK_IMPORTED_MODULE_5__["g_x"]]; //const y2 = heightMap[heightIndex2 + h_cutZ] === -1 ? heightMap[heightIndex2] : heightMap[heightIndex2 + h_cutZ];

    var y2 = heightMap[heightIndex2];
    var z2 = graph[n2 + _fforw_organic_quads__WEBPACK_IMPORTED_MODULE_5__["g_y"]];
    var x3 = graph[n3 + _fforw_organic_quads__WEBPACK_IMPORTED_MODULE_5__["g_x"]]; //const y3 = heightMap[heightIndex3 + h_cutZ] === -1 ? heightMap[heightIndex3] : heightMap[heightIndex3 + h_cutZ];

    var y3 = heightMap[heightIndex3];
...
/******/ });
//# sourceMappingURL=bundle-main-19644a2c57394d0101f7.js.map