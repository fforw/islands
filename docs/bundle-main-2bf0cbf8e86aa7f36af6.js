...
function heightFn(x0, z0) {
  ...
  var h = (QUARTER_HEIGHT + (noise.noise2D(x0 * NOISE_SCALE, z0 * NOISE_SCALE) - Math.random() * 0.3) * QUARTER_HEIGHT) * heightLimit;
...
function addHeightMap() {
  ...
  for (var i = 0; i < length; i += _fforw_organic_quads__WEBPACK_IMPORTED_MODULE_6__["t_size"]) {
    ...
    var n2 = tiles[i + _fforw_organic_quads__WEBPACK_IMPORTED_MODULE_6__["t_n2"]];
    var n3 = tiles[i + _fforw_organic_quads__WEBPACK_IMPORTED_MODULE_6__["t_n3"]];
    var tIdx0 = n0 / _fforw_organic_quads__WEBPACK_IMPORTED_MODULE_6__["g_size"] * 2;
    var tIdx1 = n1 / _fforw_organic_quads__WEBPACK_IMPORTED_MODULE_6__["g_size"] * 2;
    var tIdx2 = n2 / _fforw_organic_quads__WEBPACK_IMPORTED_MODULE_6__["g_size"] * 2;
    var tIdx3 = n3 / _fforw_organic_quads__WEBPACK_IMPORTED_MODULE_6__["g_size"] * 2;
    ...
    var z3 = graph[n3 + _fforw_organic_quads__WEBPACK_IMPORTED_MODULE_6__["g_y"]];
    var ax = x0 - x1;
    var ay = y0 - y1;
    var az = z0 - z1;
    var bx = x2 - x1;
...
/******/ });
//# sourceMappingURL=bundle-main-2bf0cbf8e86aa7f36af6.js.map