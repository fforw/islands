...
var STONE = 5;
var STONE2 = 6;
var GROUND_COLORS = (_GROUND_COLORS = {}, _defineProperty(_GROUND_COLORS, WATER, [0, 0.4, 0.8]), _defineProperty(_GROUND_COLORS, SAND, [0.8, 0.8, 0]), _defineProperty(_GROUND_COLORS, GRASS, [0, 0.5, 0]), _defineProperty(_GROUND_COLORS, DIRT, [0.5, 0.3, 0.1]), _defineProperty(_GROUND_COLORS, FOREST, [0.2, 0.4, 0.3]), _defineProperty(_GROUND_COLORS, STONE, [0.5, 0.5, 0.5]), _defineProperty(_GROUND_COLORS, STONE2, [0.9, 0.9, 0.9]), _GROUND_COLORS);
var container, stats;
...
function createScene() {
  ...
  for (var i = 0; i < length; i += _fforw_organic_quads__WEBPACK_IMPORTED_MODULE_5__["g_size"]) {
    ...
    heightMap[pos + h_ground] = graph[i + _fforw_organic_quads__WEBPACK_IMPORTED_MODULE_5__["g_isEdge"]] ? SAND : STONE2;
    pos += h_size;
  }
...
function addHeightMap() {
  ...
  var getColor = function getColor(hIdx) {
    ...
    var tileIndex = hIdx * _fforw_organic_quads__WEBPACK_IMPORTED_MODULE_5__["t_size"] / h_size;
    var color = GROUND_COLORS[heightMap[hIdx + h_ground]];

    if (color === SAND) {
      return GROUND_COLORS[SAND];
    }

    if (tileData[tileDataIndex + td_walkable]) {
...
/******/ });
//# sourceMappingURL=bundle-main-5cde58596bb77ce8d214.js.map