...
function cutCliffs() {
  ...
  for (var i = 0; i < length; i += _fforw_organic_quads__WEBPACK_IMPORTED_MODULE_5__["t_size"]) {
    // find indizes for connected centroid (values might be -1 if on the edge or already cut)
    ...
    if (cutMask !== 0) {
      ...
      for (var _j = 0; _j < 4; _j++) {
        if (cutMask & 1 << _j) {
          ...
          console.log("Cut #" + heightMapIndex / h_size, height);
...
function createScene() {
  ...
  for (var i = 0; i < length; i += _fforw_organic_quads__WEBPACK_IMPORTED_MODULE_5__["g_size"]) {
    ...
    heightMap[pos + h_ground] = STONE;
    heightMap[pos + h_cutZ] = -1;
    pos += h_size;
  }
...
/******/ });
//# sourceMappingURL=bundle-main-04248f6372eaa49b0c1a.js.map