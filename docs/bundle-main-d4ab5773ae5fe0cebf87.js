...
/* harmony import */ var _fforw_organic_quads__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! @fforw/organic-quads */ "../organic-quads/lib/index.js");
/* harmony import */ var _fforw_organic_quads__WEBPACK_IMPORTED_MODULE_6___default = /*#__PURE__*/__webpack_require__.n(_fforw_organic_quads__WEBPACK_IMPORTED_MODULE_6__);
/* harmony import */ var _loadScene__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! ./loadScene */ "./src/loadScene.js");
/* harmony import */ var three_examples_jsm_objects_Water_js__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(/*! three/examples/jsm/objects/Water.js */ "./node_modules/three/examples/jsm/objects/Water.js");
/* harmony import */ var three_examples_jsm_objects_Sky_js__WEBPACK_IMPORTED_MODULE_9__ = __webpack_require__(/*! three/examples/jsm/objects/Sky.js */ "./node_modules/three/examples/jsm/objects/Sky.js");
...
/* harmony import */ var _loadTexture__WEBPACK_IMPORTED_MODULE_11__ = __webpack_require__(/*! ./loadTexture */ "./src/loadTexture.js");
/* harmony import */ var _worker_Services__WEBPACK_IMPORTED_MODULE_12__ = __webpack_require__(/*! ./worker/Services */ "./src/worker/Services.js");
var _colors;
...
var FOREST = 4;
var ROCK = 5;
var colors = (_colors = {}, _defineProperty(_colors, WATER, [0, 0.4, 0.8]), _defineProperty(_colors, SAND, [0.8, 0.8, 0]), _defineProperty(_colors, GRASS, [0, 0.5, 0]), _defineProperty(_colors, DIRT, [0.5, 0.3, 0.1]), _defineProperty(_colors, FOREST, [0.2, 0.4, 0.3]), _defineProperty(_colors, ROCK, [0.5, 0.5, 0.5]), _colors);
var container, stats;
...
function updateCentroids(organicQuads, centroids) {
  var graph = organicQuads.graph,
      tiles = organicQuads.tiles,
      config = organicQuads.config;
  var length = tiles.length;
  var cPos = 0;

  for (var i = 0; i < length; i += _fforw_organic_quads__WEBPACK_IMPORTED_MODULE_6__["t_size"]) {
    var n0 = tiles[i + _fforw_organic_quads__WEBPACK_IMPORTED_MODULE_6__["t_n0"]];
    var n1 = tiles[i + _fforw_organic_quads__WEBPACK_IMPORTED_MODULE_6__["t_n1"]];
    var n2 = tiles[i + _fforw_organic_quads__WEBPACK_IMPORTED_MODULE_6__["t_n2"]];
    var n3 = tiles[i + _fforw_organic_quads__WEBPACK_IMPORTED_MODULE_6__["t_n3"]];
    var cx = (graph[n0 + _fforw_organic_quads__WEBPACK_IMPORTED_MODULE_6__["g_x"]] + graph[n1 + _fforw_organic_quads__WEBPACK_IMPORTED_MODULE_6__["g_x"]] + graph[n2 + _fforw_organic_quads__WEBPACK_IMPORTED_MODULE_6__["g_x"]] + graph[n3 + _fforw_organic_quads__WEBPACK_IMPORTED_MODULE_6__["g_x"]]) / 4;
    var cy = (graph[n0 + _fforw_organic_quads__WEBPACK_IMPORTED_MODULE_6__["g_y"]] + graph[n1 + _fforw_organic_quads__WEBPACK_IMPORTED_MODULE_6__["g_y"]] + graph[n2 + _fforw_organic_quads__WEBPACK_IMPORTED_MODULE_6__["g_y"]] + graph[n3 + _fforw_organic_quads__WEBPACK_IMPORTED_MODULE_6__["g_y"]]) / 4;
    centroids[cPos++] = cx;
    centroids[cPos++] = cy;
  }
}
...
function heightFn(x0, z0) {
  ...
  var FACTOR = Math.PI / 2 / 400;
  var heightLimit = distance < 400 ? Math.cos(distance * FACTOR) : 0.05;
  var h = (QUARTER_HEIGHT + (noise.noise2D(x0 * NOISE_SCALE, z0 * NOISE_SCALE) - Math.random() * RANDOM_FACTOR) * QUARTER_HEIGHT) * heightLimit;
  return Math.max(0.1, h);
}

function createScene() {
  organicQuads = new _fforw_organic_quads__WEBPACK_IMPORTED_MODULE_6___default.a({
    numberOfRings: 6,
    width: 1000,
    height: 1000,
  ...
  var length = graph.length;
  heightMap = new Float64Array(length / _fforw_organic_quads__WEBPACK_IMPORTED_MODULE_6__["g_size"] * 2);
  var pos = 0;

  for (var i = 0; i < length; i += _fforw_organic_quads__WEBPACK_IMPORTED_MODULE_6__["g_size"]) {
    heightMap[pos++] = heightFn(graph[i + _fforw_organic_quads__WEBPACK_IMPORTED_MODULE_6__["g_x"]], graph[i + _fforw_organic_quads__WEBPACK_IMPORTED_MODULE_6__["g_y"]]);
    heightMap[pos++] = SAND;
  }
  ...
  centroids = new Float64Array(organicQuads.tiles.length / _fforw_organic_quads__WEBPACK_IMPORTED_MODULE_6__["t_size"] * 2);
  updateCentroids(organicQuads, centroids);
}
...
var CLIFF_THRESHOLD = 14;
var RANDOM_FACTOR = 0.1;
...
function addHeightMap() {
  ...
  var _organicQuads2 = organicQuads,
      ...
      config = _organicQuads2.config;
  var length = tiles.length;
  console.log("Height map for ", length / _fforw_organic_quads__WEBPACK_IMPORTED_MODULE_6__["t_size"], " tiles");
  var heightIndexFactor = 2 / _fforw_organic_quads__WEBPACK_IMPORTED_MODULE_6__["g_size"];
  var centroidsFactor = 2 / _fforw_organic_quads__WEBPACK_IMPORTED_MODULE_6__["t_size"];
  var max = 0;
  ...
  for (var i = 0; i < length; i += _fforw_organic_quads__WEBPACK_IMPORTED_MODULE_6__["t_size"]) {
    ...
    var n1 = tiles[i + _fforw_organic_quads__WEBPACK_IMPORTED_MODULE_6__["t_n1"]];
    var n2 = tiles[i + _fforw_organic_quads__WEBPACK_IMPORTED_MODULE_6__["t_n2"]];
    var n3 = tiles[i + _fforw_organic_quads__WEBPACK_IMPORTED_MODULE_6__["t_n3"]]; // equivalent height map indizes

    var tIdx0 = n0 * heightIndexFactor;
    var tIdx1 = n1 * heightIndexFactor;
    var tIdx2 = n2 * heightIndexFactor;
    var tIdx3 = n3 * heightIndexFactor; // find indizes for connected centroid

    var centroid = i * centroidsFactor;
    var centroid0 = tiles[i + _fforw_organic_quads__WEBPACK_IMPORTED_MODULE_6__["t_tile0"]] * centroidsFactor;
    var centroid1 = tiles[i + _fforw_organic_quads__WEBPACK_IMPORTED_MODULE_6__["t_tile1"]] * centroidsFactor;
    var centroid2 = tiles[i + _fforw_organic_quads__WEBPACK_IMPORTED_MODULE_6__["t_tile2"]] * centroidsFactor;
    var centroid3 = tiles[i + _fforw_organic_quads__WEBPACK_IMPORTED_MODULE_6__["t_tile3"]] * centroidsFactor;
    var centerHeight = heightFn(centroids[centroid], centroids[centroid + 1]);
    var hNext0 = heightFn(centroids[centroid0], centroids[centroid0 + 1]);
    var hNext1 = heightFn(centroids[centroid1], centroids[centroid1 + 1]);
    var hNext2 = heightFn(centroids[centroid2], centroids[centroid2 + 1]);
    var hNext3 = heightFn(centroids[centroid3], centroids[centroid3 + 1]);
    var x0 = graph[n0 + _fforw_organic_quads__WEBPACK_IMPORTED_MODULE_6__["g_x"]];
    var y0 = heightMap[tIdx0];
    var z0 = graph[n0 + _fforw_organic_quads__WEBPACK_IMPORTED_MODULE_6__["g_y"]];
    var x1 = graph[n1 + _fforw_organic_quads__WEBPACK_IMPORTED_MODULE_6__["g_x"]];
    var y1 = heightMap[tIdx1];
    var z1 = graph[n1 + _fforw_organic_quads__WEBPACK_IMPORTED_MODULE_6__["g_y"]];
    var x2 = graph[n2 + _fforw_organic_quads__WEBPACK_IMPORTED_MODULE_6__["g_x"]];
    var y2 = heightMap[tIdx2];
    var z2 = graph[n2 + _fforw_organic_quads__WEBPACK_IMPORTED_MODULE_6__["g_y"]];
    var x3 = graph[n3 + _fforw_organic_quads__WEBPACK_IMPORTED_MODULE_6__["g_x"]];
    var y3 = heightMap[tIdx3];
    var z3 = graph[n3 + _fforw_organic_quads__WEBPACK_IMPORTED_MODULE_6__["g_y"]]; // max = Math.max(max, Math.abs(centerHeight-hNext0))
    // max = Math.max(max, Math.abs(centerHeight-hNext1))
    // max = Math.max(max, Math.abs(centerHeight-hNext2))
    // max = Math.max(max, Math.abs(centerHeight-hNext3))

    if (Math.abs(centerHeight - hNext0) > CLIFF_THRESHOLD) {
      y0 = centerHeight;
    }

    if (Math.abs(centerHeight - hNext1) > CLIFF_THRESHOLD) {
      y1 = centerHeight;
    }

    if (Math.abs(centerHeight - hNext2) > CLIFF_THRESHOLD) {
      y2 = centerHeight;
    }

    if (Math.abs(centerHeight - hNext3) > CLIFF_THRESHOLD) {
      y3 = centerHeight;
    }
  ...
  geometry.setAttribute('position', new three__WEBPACK_IMPORTED_MODULE_5__["Float32BufferAttribute"](vertices, 3));
  geometry.setAttribute('normal', new three__WEBPACK_IMPORTED_MODULE_5__["Float32BufferAttribute"](normals, 3));
  geometry.setAttribute('color', new three__WEBPACK_IMPORTED_MODULE_5__["Float32BufferAttribute"](colors, 3));
  ...
  var mesh = new three__WEBPACK_IMPORTED_MODULE_5__["Mesh"](geometry, material); // var wireframe = new WireframeGeometry( geometry );
  //
...
function init() {
  ...
  camera = new three__WEBPACK_IMPORTED_MODULE_5__["PerspectiveCamera"](55, window.innerWidth / window.innerHeight, 1, 20000);
  camera.position.set(250, 250, 1000); //

  light = new three__WEBPACK_IMPORTED_MODULE_5__["DirectionalLight"]("#fff8d5", 0.8);
  scene.add(light);
  var cubeCamera = new three__WEBPACK_IMPORTED_MODULE_5__["CubeCamera"](0.2, 1, 512);
  cubeCamera.renderTarget.texture.generateMipmaps = true;
  cubeCamera.renderTarget.texture.minFilter = three__WEBPACK_IMPORTED_MODULE_5__["LinearMipmapLinearFilter"];
  scene.background = cubeCamera.renderTarget; // Water

  var waterGeometry = new three__WEBPACK_IMPORTED_MODULE_5__["PlaneBufferGeometry"](10000, 10000);

  if (EFFECTS) {
    water = new three_examples_jsm_objects_Water_js__WEBPACK_IMPORTED_MODULE_8__["Water"](waterGeometry, {
      textureWidth: 512,
      textureHeight: 512,
    ...
    var mesh = new three__WEBPACK_IMPORTED_MODULE_5__["Mesh"](waterGeometry, material);
  ...
  if (EFFECTS) {
    sky = new three_examples_jsm_objects_Sky_js__WEBPACK_IMPORTED_MODULE_9__["Sky"]();
  ...
  controls = new three_examples_jsm_controls_OrbitControls__WEBPACK_IMPORTED_MODULE_10__["OrbitControls"](camera, renderer.domElement);
...
Promise.all([Object(_loadScene__WEBPACK_IMPORTED_MODULE_7__["default"])("assets/tiles.glb"), Object(_loadScene__WEBPACK_IMPORTED_MODULE_7__["default"])("assets/ground.glb"), Object(_loadScene__WEBPACK_IMPORTED_MODULE_7__["default"])("assets/ms.glb"), Object(_loadScene__WEBPACK_IMPORTED_MODULE_7__["default"])("assets/ms-raised.glb"), Object(_loadTexture__WEBPACK_IMPORTED_MODULE_11__["default"])("assets/waternormals.jpg")]).then(function (_ref) {
  ...
  var msMap = extractMarchingSquares(marchingSquares.scene);
  var msMapRaised = extractMarchingSquares(marchingSquaresRaised.scene);
  console.log({
    msMap: msMap,
    msMapRaised: msMapRaised
  ...
  tWaterNormals.wrapS = tWaterNormals.wrapT = three__WEBPACK_IMPORTED_MODULE_5__["RepeatWrapping"];
...
/******/ });
//# sourceMappingURL=bundle-main-d4ab5773ae5fe0cebf87.js.map