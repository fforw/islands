...
function addHeightMap() {
  ...
  for (var i = 0; i < length; i += _fforw_organic_quads__WEBPACK_IMPORTED_MODULE_5__["t_size"]) {
    ...
    var y0 = heightMap[heightIndex0 + h_height];
    ...
    var y1 = heightMap[heightIndex1 + h_height];
    ...
    var y2 = heightMap[heightIndex2 + h_height];
    ...
    var y3 = heightMap[heightIndex3 + h_height];
...
/******/ });
//# sourceMappingURL=bundle-main-4133ecc656cd684ad401.js.map